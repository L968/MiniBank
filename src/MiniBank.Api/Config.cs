...
internal static class Config
{
    ...
    {
        DatabaseConnectionString = configuration.GetConnectionString("minibank-mysqldb") ?? throw new MissingConfigurationException("ConnectionStrings:Database");
        RabbitMQConnectionString = configuration.GetConnectionString("minibank-rabbitmq") ?? throw new MissingConfigurationException("ConnectionStrings:RabbitMQ");
